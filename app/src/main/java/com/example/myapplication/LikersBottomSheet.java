...
public class LikersBottomSheet extends BottomSheetDialogFragment {
    ...
    public LikersBottomSheet(String showId, String type) {
        this.showId = showId;
        this.type = type;
    }
                ...
                .addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        ...
                        if (user != null) {
                            ...
                            // שימוש ב-notifyItemInserted במקום notifyDataSetChanged לשיפור ביצועים (אנימציה חלקה יותר של כניסת פריטים).
